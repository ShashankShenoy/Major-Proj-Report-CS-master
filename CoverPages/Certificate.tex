...
\small \textbf{Project Guide} & \small \textbf{Head of the Department} & \small \textbf{Dean CS Cluster} & \small \textbf{Principal} \\[0.2cm] 
...
\hspace{1cm} \textbf{Name of Examiner} & \textbf{Signature with Date} \\[0.5cm] 
1. & \\[0.5cm]
2. & \\
\end{tabular}
\end{table}
