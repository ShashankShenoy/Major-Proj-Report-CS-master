...
Python was chosen for its unparalleled ecosystem in deep learning.
\section{Platform Selection}
Developed on Windows/Linux environments utilizing NVIDIA CUDA for GPU acceleration.
\section{Code Conventions}
PEP 8 standards were followed for Python code to ensure maintainability.
\section{Difficulties Encountered and Strategies Used to Tackle}
Occlusions and glare were primary challenges. These were tackled by integrating DeepOCSORT with appearance-based ReID.
\section{Data Set}
The dataset details are provided in the experimental setup.
