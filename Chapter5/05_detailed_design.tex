...
Beyond operational resilience, this hierarchical decomposition allows for rapid technological upgrades. As state-of-the-art computer vision models evolve, new detection weights can be seamlessly hot-swapped into the perception layer without requiring the entire prediction matrix to be rewritten. The structure chart shown in Fig.~\ref{fig:structure} illustrates this modular decomposition of the system, beginning from data acquisition and progressing through vessel detection, tracking, sensor fusion, trajectory prediction, collision risk analysis, and visualization. Such a modular design improves maintainability, scalability, and ease of future system enhancements by allowing individual modules to be developed and upgraded independently.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{Chapter5/Figures/algorithm_selection.png}
...
\section{Summary}
This chapter detailed the foundational design and mathematical methodology of the proposed system. Operational parameters were established for the entire pipeline, and architectural choices like YOLOv8 and DeepOCSORT were justified. By routing data through a structured sequence of functional modules, the system offers a cohesive solution for intelligent vessel monitoring.
